...
class ModifyWorkspaceMembersAndSettingsRule : AccessRule<Workspace, WorkspaceExecutableAction, WorkspaceAccessor> {
    override fun isApplicableForRequest(request: WorkspaceExecutableAction): Boolean {
        return WorkspaceExecutableAction.MODIFY_MEMBERS == request
                || WorkspaceExecutableAction.MODIFY_SETTINGS == request
    }
